...
| 工具 | 特点 | 适合场景 |
|------|------|----------|
| 🦞 **豆包**（字节跳动） | 支持上传文件，一键生成 PPTX | 快速转换，日常使用 |
| 🤖 **Claude**（Anthropic） | 理解复杂布局，还原精度高 | 精细还原，复杂图表 |
| ✨ **通义千问**（阿里） | 中文场景优化，PPT 生成流畅 | 中文报告 |
| 💡 **Kimi**（月之暗面） | 长上下文，支持完整 HTML 输入 | 多页批量处理 |
...
![P07 仪表盘](demo/07-t4-dashboard.PNG)
...
![P09 赛博](demo/09-t6-cyberpunk.PNG)
...
![P10 设计模式](demo/10-design-patterns.PNG)
